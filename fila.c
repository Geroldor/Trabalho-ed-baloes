...
int main() {
    ...
    insereFila(fila, &valor1);
    insereFila(fila, &valor2);
    insereFila(fila, &valor3);
    insereFila(fila, &valor4);
    insereFila(fila, &valor5);

    // Verificando o tamanho da fila
    printf("Tamanho da fila: %d\n", tamanhoFila(fila));

    // Imprimindo o valor do elemento que está no início da fila
    printf("Elemento no início da fila: %d\n", *(int*)inicioFila(fila));

    // Imprimindo o valor do elemento que está no final da fila
    printf("Elemento no final da fila: %d\n", *(int*)finalFila(fila));
